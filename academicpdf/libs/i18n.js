...
const I18n = {
    en: {
        popup: {
            ...
            tip: "Tip: While Academia and Scribd pages are open, the Panel can be minimized/maximized from the header and dragged anywhere on the page.",
            footer: ""
        },
        overlay: {
    ...
    tr: {
        popup: {
            ...
            step3: "Dosyayı kaydetmek için <strong>'Orijinal PDF'</strong> seçeneğine tıklayın veya diğer kaydetme yöntemlerini deneyin.",
            tip: "İpucu: Academia ve Scribd sayfaları açık iken Panelin başlık kısmından minimize/maksimize edilebilir ayrıca sayfa içinde istenilen yere sürüklenebilir.",
            footer: ""
        },
        overlay: {
            title: "⚡ Scribd Downloader",
